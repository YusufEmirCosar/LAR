...
| --- | --- | --- |
| Single Responsibility | Mapping, validation, lifecycle, capture, recording time, drain/persistence policy, playback, UI workflow, rendering, and storage have distinct owners | Focused classes, CMake targets, file-size gate, service/unit tests |
